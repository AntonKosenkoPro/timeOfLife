...
enum L10n: String, CaseIterable {
    ...
    case timerSearchConfigure = "timer.searchConfigure"
    ...
    case timerCollisionTitle = "timer.collisionTitle"
    case timerCollisionMessage = "timer.collisionMessage"
    case timerCollisionUseExisting = "timer.collisionUseExisting"
    case timerCollisionKeepEditing = "timer.collisionKeepEditing"
