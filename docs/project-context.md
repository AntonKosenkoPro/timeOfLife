...
Do not claim these are done. The following remain open (no active changes right now — leftovers live in `docs/history-roadmap.md` and archived change tasks):
